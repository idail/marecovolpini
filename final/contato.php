            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <form class="form-contact contact_form" id="formulario_contato" novalidate="novalidate">
                        ...
                        <div class="alert alert-primary col-lg-5" role="alert" id="validacao_campos">

                        </div>

                        <div class="alert alert-primary col-lg-5" role="alert" id="envio_email">
