$(document).ready(function (e) {
    ...
    $("#envio_fotos_galeria").click(function (event) {
        ...
        $.ajax({
            ...
            dataType: "json",
            //http://localhost/engenharia/controladora/ImagemControladora.php
            ...
            if (retorno != null) {
                ...
                while (contador_imagens < retorno.length) {
                    ...
                    recebe_imagens.innerHTML +=
                        ...
                        "<img class='d-block w-100' id='imagem_galeria' src='Imagens/Galeria/" + retorno[contador_imagens].imagem + "'  alt='Second slide' style='background-size: cover;height: 700px;width: 400px;'>" +
